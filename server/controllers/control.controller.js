...
const actions = {
  ...
  "tiebreak.begin": () => game.beginTieBreak(),
  "tiebreak.pick": (p) => game.pickTieBreakQuestion(p.question),
  "tiebreak.reset": () => game.resetTieBreak(),
  "tiebreak.show": () => game.showTieBreakQuestion(),
  "tiebreak.start": () => game.startTieBreakTimer(),
  "tiebreak.close": () => game.closeTieBreak(),
